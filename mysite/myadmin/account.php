...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['submit'])) {
      ...
      $stmt->bind_param('ssssssiiii', $_POST['username'], $password, $_POST['email'], $_POST['activation_code'], $_POST['rememberme'], $_POST['role'], $_POST['profit'], $_POST['amount_invested'], $_POST['earnings_mon'], $_GET['id']);
      $stmt->execute();
...
<div class="content-block">
    <form action="" method="post" class="form responsive-width-100">
        ...
        <input type="text" id="profit" name="profit" placeholder="Profit" value="<?=$profit?>">
        <label for="role">Amount invested</label>
        <input type="text" id="profit" name="amount_invested" placeholder="Profit" value="<?=$amount_invested?>">
